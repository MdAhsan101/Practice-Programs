...
int FindNoOfComponents(vector<int> G[],int n)
{
...
int main()
{
    ...
    int comp= FindNoOfComponents(G,n);
    cout<<"The graph has "<< comp <<" components."<<endl;
...
Enter no. of node and edges resp. the graph have : 8 9
